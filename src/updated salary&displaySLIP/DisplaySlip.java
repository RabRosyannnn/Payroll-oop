    ...
    public void SetText()
{
    if (SlipID.contains("F")) {
        ...
        try {
            ...
            while(rs.next())
            {
                ...
                // Retrieve EPF and ETF values
                EPF = rs.getDouble("EPF");
                ETF = rs.getDouble("ETF");

                double Tax = Double.valueOf(txtTax.getText());
                double EPFDeduction = Double.valueOf(txtEPFDeduction.getText());

                Deductions = Tax + EPFDeduction + EPF + ETF;
                txtDeductions.setText(String.valueOf(Deductions));

                // Add EPF and ETF to the tax field
                double totalTaxWithEPFAndETF = Tax + EPF + ETF;
                txtTax.setText(String.valueOf(totalTaxWithEPFAndETF));
            }
    ...
    private void initComponents() {
        ...
        txtEPFFixed = new javax.swing.JLabel();
        ...
        jLabel13.setText("Govt. Contribution");
        ...
        txtEPFFixed.setFont(new java.awt.Font("Arial Narrow", 0, 12)); // NOI18N
        txtEPFFixed.setIcon(new javax.swing.ImageIcon(getClass().getResource("/XYZCompany/SlipDisplayBackground.png"))); // NOI18N
        txtEPFFixed.setAutoscrolls(true);
        getContentPane().add(txtEPFFixed, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
    ...
    private javax.swing.JLabel txtEPFFixed;
